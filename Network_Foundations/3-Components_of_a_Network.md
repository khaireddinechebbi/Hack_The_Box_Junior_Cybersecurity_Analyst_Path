...
## Question 3:
What software is used to oversee and administer network operations?
`Network Management software`

## Question 4:
What software is used to protect individual devices from unauthorized network access?
`Firewall`
