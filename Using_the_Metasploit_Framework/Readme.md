...
In this module, we covered the basic functionality and structure of the Metasploit Framework. We have thus laid a foundation for using this tool and can use it as a basis for incorporating the tool into all other modules.
